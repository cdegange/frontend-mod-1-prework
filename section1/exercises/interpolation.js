...
// Your answer and explanation here: A string because we have used interpolation to combine our variables and strings.
...
`The ${speedy} jumped over the ${slowPoke}`
...
`In a predictable result, the ${slowPoke} beat the ${speedy}!`
